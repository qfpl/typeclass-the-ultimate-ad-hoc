...
Ophan instances break {\it type class coherence}
\end{center}
...
implicit def personOrderByName: Order[Person] = ...
...
\item Disallow creating local instances (regardless of which file you're in)
\end{itemize}

\pnl

Recommendations when working with implicits in external libraries:
\begin{itemize}
